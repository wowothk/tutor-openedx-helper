...
const GenerateCourseButton = ({
  ...
  const [instruction, setInstruction] = React$1.useState("");
  const [outline, setOutline] = React$1.useState("");
  ...
  return /*#__PURE__*/React$1.createElement(React$1.Fragment, null, /*#__PURE__*/React$1.createElement(paragon.Button, {
    variant: "outline-primary",
    onClick: () => setOpen(true)
  }, "Generate Course With AI"), /*#__PURE__*/React$1.createElement(paragon.StandardModal, {
    ...
    footerNode: loading ? null : success ? /*#__PURE__*/React$1.createElement(paragon.ActionRow, null, /*#__PURE__*/React$1.createElement(paragon.ActionRow.Spacer, null), /*#__PURE__*/React$1.createElement(paragon.Button, {
      variant: "tertiary",
      onClick: resetForm
    }, "Generate Another"), /*#__PURE__*/React$1.createElement(paragon.Button, {
      onClick: () => {
        setOpen(false);
        resetForm();
        window.location.reload();
      }
    }, "Close")) : /*#__PURE__*/React$1.createElement(paragon.ActionRow, null, /*#__PURE__*/React$1.createElement(paragon.ActionRow.Spacer, null), /*#__PURE__*/React$1.createElement(paragon.Button, {
      variant: "tertiary",
      onClick: () => {
        setOpen(false);
        resetForm();
      }
    }, "Cancel"), /*#__PURE__*/React$1.createElement(paragon.Button, {
  ...
  }, /*#__PURE__*/React$1.createElement(paragon.Spinner, {
    animation: "border",
    size: "lg"
  ...
  }, "Please wait for a moment.")) : success ? /*#__PURE__*/React$1.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '40px 20px'
    }
  }, /*#__PURE__*/React$1.createElement(paragon.Alert, {
    variant: "success",
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, "Your outline was generated successfully")), outline && /*#__PURE__*/React$1.createElement("div", {
    style: {
      marginTop: '20px',
      padding: '15px',
  ...
  }, /*#__PURE__*/React$1.createElement("h5", null, "Generated Course Outline:"), /*#__PURE__*/React$1.createElement("div", {
    style: {
      fontSize: '14px',
      lineHeight: '1.6',
      color: '#333'
    ...
    components: {
      ...
      ol: ({
        children
      }) => /*#__PURE__*/React$1.createElement("ol", {
        style: {
          margin: '10px 0',
          paddingLeft: '20px'
        }
  ...
  }, outline)))) : /*#__PURE__*/React$1.createElement(paragon.Form, null, /*#__PURE__*/React$1.createElement(paragon.Form.Label, null, "Instruksi"), /*#__PURE__*/React$1.createElement(paragon.Form.Control, {
    as: "textarea",
    rows: 5,
    placeholder: "Masukkan instruksi Anda di sini...",
    value: instruction,
    onChange: e => setInstruction(e.target.value)
  }), error && /*#__PURE__*/React$1.createElement(paragon.Alert, {
    variant: "danger",
    style: {
      marginTop: '10px',
      marginLeft: '-10px'
  ...
  })), /*#__PURE__*/React$1.createElement("p", null, error))))));
};
...
const GenerateCourseWithAI = ({
  ...
  course = "Cs01",
  run = "2022",
  baseURL = frontendPlatform.getConfig().LMS_BASE_URL
}) => {
  const [open, setOpen] = React$1.useState(false);
  const [models, setModels] = React$1.useState([]);
  const [selectedModel, setSelectedModel] = React$1.useState("");
  const [instruction, setInstruction] = React$1.useState("");
  const [outline, setOutline] = React$1.useState("");
  const [loading, setLoading] = React$1.useState(false);
  const [loadingModels, setLoadingModels] = React$1.useState(false);
  const [error, setError] = React$1.useState("");
  const [success, setSuccess] = React$1.useState(false);
...
[
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(paragon.Button, {
    ...
    isOverflowVisible: false
  }, loadingModels ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '40px 20px'
    }
  ...
  }, "Loading available models...")) : loading ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '40px 20px'
    }
  ...
  }, "Generating course outline with AI...")) : success ? /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: 'center',
      padding: '40px 20px'
    }
  ...
  }, outline)))) : /*#__PURE__*/React.createElement(paragon.Form, null, /*#__PURE__*/React.createElement(paragon.Form.Group, {
    className: "mb-3"
  }, /*#__PURE__*/React.createElement(paragon.Form.Label, null, "AI Model"), /*#__PURE__*/React.createElement(paragon.Form.Control, {
    as: "select",
    value: selectedModel,
    onChange: e => setSelectedModel(e.target.value),
    disabled: models.length === 0
  }, models.length === 0 ? /*#__PURE__*/React.createElement("option", {
    value: ""
  }, "No models available") : models.map(model => /*#__PURE__*/React.createElement("option", {
    key: model.id,
    value: model.id
  }, model.name || model.id, " ", model.provider ? `(${model.provider})` : ''))), /*#__PURE__*/React.createElement(paragon.Form.Text, {
    className: "text-muted"
  }, "Select the AI model to generate your course outline")), /*#__PURE__*/React.createElement(paragon.Form.Group, {
    className: "mb-3"
  }, /*#__PURE__*/React.createElement(paragon.Form.Label, null, "Instruction"), /*#__PURE__*/React.createElement(paragon.Form.Control, {
    as: "textarea",
    rows: 5,
    placeholder: "Enter your instruction here...",
    value: instruction,
    onChange: e => setInstruction(e.target.value)
  }), /*#__PURE__*/React.createElement(paragon.Form.Text, {
    className: "text-muted"
  }, "Describe the course you want to generate")), error && /*#__PURE__*/React.createElement(paragon.Alert, {
    variant: "danger",
    style: {
      marginTop: '10px',
      marginLeft: '-10px'
...
const StudioFooter = ({
  ...
  return /*#__PURE__*/React$1.createElement("footer", {
  ...
  }, /*#__PURE__*/React$1.createElement(paragon.Container, {
    style: {
      fontSize: '14px'
    }
  ...
  }), /*#__PURE__*/React$1.createElement(paragon.Row, {
    className: "justify-content-between py-4"
  }, /*#__PURE__*/React$1.createElement(paragon.Col, {
    md: 4,
    ...
    className: "mb-3"
  }, description)), /*#__PURE__*/React$1.createElement(paragon.Col, {
    md: 4,
    className: "text-right"
  }, /*#__PURE__*/React$1.createElement("h5", {
    className: "mb-3"
  }, "Contact"), /*#__PURE__*/React$1.createElement("p", {
    className: "mb-1"
  }, email), /*#__PURE__*/React$1.createElement("p", {
    className: "mb-3"
  }, phone))), /*#__PURE__*/React$1.createElement("hr", {
    style: {
      borderTop: '1px solid #ccc',
      margin: '0'
    }
  }), /*#__PURE__*/React$1.createElement(paragon.Row, null, /*#__PURE__*/React$1.createElement(paragon.Col, {
  ...
  }, "\xA9 ", currentYear, " Studio. All rights reserved.")))));
};

exports.GenerateCourseButton = GenerateCourseButton;
exports.GenerateCourseWithAI = GenerateCourseWithAI;
exports.StudioFooter = StudioFooter;
